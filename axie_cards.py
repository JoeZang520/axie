...
axie_cards = {
    ...
    "back1523": [
        ("zeal", 0, False, None, None),  # 0费
        ("confident", 0, True, "ally", "all"),  # 0费 s
    ...
    "back11468703": [
        ("zeal", 0, False, None, None),  # 0费
        ("curved_spine", 1, True, "ally", "all"), 
        ("wall_gecko", 1, False, None, None),
        ("blue1", 1, True, "ally", "all"), 
        ("shiitake", 1, True, "ally", "all"), 
        ("bumpy", 1, True, "ally", "all"),
    ],
    "back11958130": [
        ("green1", 1, True, "ally", "all"),
    ...
    "burn": [
        ("burn_card", 0, False, None, None)  # 0费
    ],
    "goo": [
...
# 通用卡牌列表
COMMON_CARDS = ['glove', 'helmet', 'sword', 'knife', 'shield', 'axe', "blackmail", "energy_coin", "burn", "goo", "jinx", "confused"]
